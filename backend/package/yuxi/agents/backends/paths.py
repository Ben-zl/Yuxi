...
VIRTUAL_PATH_WORKSPACE = f"{VIRTUAL_PATH_PREFIX.rstrip('/')}/{WORKSPACE_DIR_NAME}"
VIRTUAL_PATH_UPLOADS = f"{VIRTUAL_PATH_PREFIX.rstrip('/')}/{UPLOADS_DIR_NAME}"
VIRTUAL_PATH_OUTPUTS = f"{VIRTUAL_PATH_PREFIX.rstrip('/')}/{OUTPUTS_DIR_NAME}"
