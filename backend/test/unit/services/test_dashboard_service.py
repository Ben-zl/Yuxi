...
async def dashboard_db():
    ...
    async with factory() as db:
        ...
        projects = [
            ...
            for project_id, uid, project_status in [
                ("p-1", "uid-alice", "active"),
                ("p-2", "uid-bob", "active"),
                ("p-3", "uid-alice", "active"),
                ("p-deleted", "uid-alice", "deleted"),
                ("p-deleted-user", "uid-deleted", "active"),
                ("p-missing-agent", "uid-alice", "active"),
                ("p-subagent", "uid-alice", "active"),
            ]
        ]
