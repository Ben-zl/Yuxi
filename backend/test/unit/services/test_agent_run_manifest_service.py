...
def _manifest(**overrides):
    payload = {
        ...
        "limits": {
            ...
            "summary_trigger_ratio": 0.8,
            "summary_reserve_ratio": 0.1,
            "summary_tool_result_token_limit": 50000,
        },
...
def test_effective_limits_fill_schema_defaults_for_unset_fields():
    ...
    assert effective["summary_trigger_ratio"] == 0.8
    assert effective["summary_reserve_ratio"] == 0.1
    assert _effective_limits(None, {"max_execution_steps": 200})["summary_trigger_ratio"] is None
